...
namespace PetStore.Views.TypeCollectionView{
    public partial class TypeCollectionView : XtraUserControl {
        public TypeCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PetStore.ViewModels.TypeCollectionViewModel>();
