...
namespace PetStore.Views.BillDetailCollectionView{
    public partial class BillDetailCollectionView : XtraUserControl {
        public BillDetailCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PetStore.ViewModels.BillDetailCollectionViewModel>();
