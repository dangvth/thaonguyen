...
namespace PetStore.Views.CommentDetailCollectionView{
    public partial class CommentDetailCollectionView : XtraUserControl {
        public CommentDetailCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PetStore.ViewModels.CommentDetailCollectionViewModel>();
